# Code written by Nagato. https://gist.github.com/polaris-/b93a771fafa2764b3199
def calc_crc16(val):
    crc16 = 0xFFFF
    table = [
        0x0000,
...
def gsid_dec(gsid):
    ...
    gsid = gsid[::-1]  # Reverse gsid string
    for c in gsid:
        output <<= 0x05

        if c in charset:
            output |= charset.index(c)
